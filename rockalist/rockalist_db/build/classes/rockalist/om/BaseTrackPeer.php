...
abstract class BaseTrackPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Url', 'Title', 'Genre', 'Year', 'DateAdded', 'ArtistId', 'AlbumId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'url', 'title', 'genre', 'year', 'dateAdded', 'artistId', 'albumId', ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID, TrackPeer::URL, TrackPeer::TITLE, TrackPeer::GENRE, TrackPeer::YEAR, TrackPeer::DATE_ADDED, TrackPeer::ARTIST_ID, TrackPeer::ALBUM_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'URL', 'TITLE', 'GENRE', 'YEAR', 'DATE_ADDED', 'ARTIST_ID', 'ALBUM_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'url', 'title', 'genre', 'year', 'date_added', 'artist_id', 'album_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Url' => 1, 'Title' => 2, 'Genre' => 3, 'Year' => 4, 'DateAdded' => 5, 'ArtistId' => 6, 'AlbumId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'url' => 1, 'title' => 2, 'genre' => 3, 'year' => 4, 'dateAdded' => 5, 'artistId' => 6, 'albumId' => 7, ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID => 0, TrackPeer::URL => 1, TrackPeer::TITLE => 2, TrackPeer::GENRE => 3, TrackPeer::YEAR => 4, TrackPeer::DATE_ADDED => 5, TrackPeer::ARTIST_ID => 6, TrackPeer::ALBUM_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'URL' => 1, 'TITLE' => 2, 'GENRE' => 3, 'YEAR' => 4, 'DATE_ADDED' => 5, 'ARTIST_ID' => 6, 'ALBUM_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'url' => 1, 'title' => 2, 'genre' => 3, 'year' => 4, 'date_added' => 5, 'artist_id' => 6, 'album_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
