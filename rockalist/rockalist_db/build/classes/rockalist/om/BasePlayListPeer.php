...
abstract class BasePlayListPeer
{
    ...
    const USER_ID = 'playlist.user_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'UserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'userId', ),
        BasePeer::TYPE_COLNAME => array (PlayListPeer::ID, PlayListPeer::NAME, PlayListPeer::USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'UserId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'userId' => 2, ),
        BasePeer::TYPE_COLNAME => array (PlayListPeer::ID => 0, PlayListPeer::NAME => 1, PlayListPeer::USER_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'USER_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'user_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlayListPeer::USER_ID);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PlayListPeer::USER_ID, UserPeer::ID, $join_behavior);
