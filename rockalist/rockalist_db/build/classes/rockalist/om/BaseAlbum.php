...
abstract class BaseAlbum extends BaseObject implements Persistent
{
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[] = AlbumPeer::YEAR;
        }
    ...
    public function setArtistId($v)
    {
        ...
        if ($this->artist_id !== $v) {
            $this->artist_id = $v;
            $this->modifiedColumns[] = AlbumPeer::ARTIST_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlbumPeer::YEAR)) {
            $modifiedColumns[':p' . $index++]  = '`year`';
        }
        if ($this->isColumnModified(AlbumPeer::ARTIST_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlbumPeer::YEAR)) $criteria->add(AlbumPeer::YEAR, $this->year);
        if ($this->isColumnModified(AlbumPeer::ARTIST_ID)) $criteria->add(AlbumPeer::ARTIST_ID, $this->artist_id);
